...
# Function to plot the candlestick chart with zones and print price ranges
...
def display_candlestick_charts():
    ...
    for stock in sorted_data:
        ...
        # Now, plot again with updated zones based on user input
        mpf.plot(candlestick_data, type='candle', style='charles', title=f"{symbol} Candlestick Chart", ylabel='Price', volume=True, datetime_format="%Y-%m-%d %H:%M")
